    ...
    def push(self):
        try:
            ...
            if response_alerts.status_code == 200:
                print("  הבקשה הצליחה:", response_alerts.json())
            else:
                print("  שגיאה בבקשה:", response_alerts.status_code, response_alerts.text)

            if response_graghs.status_code == 200:
                print("  הבקשה הצליחה:", response_graghs.json())
            else:
                print("  שגיאה בבקשה:", response_graghs.status_code, response_graghs.text)
