...
def create_item(file: File):
    ...
    open_dir(file.path)
    all_graghs()
    images = [f'./images/number_of_issues_per_file.png', f'./images/pie_chart_number_of_issues.png',
              f'./images/histogram_functions_lengths.png']
...
if __name__ == '__main__':
    # app.run(debug=True)
    uvicorn.run('API:app', host='localhost', port=5000)
